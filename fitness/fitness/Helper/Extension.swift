...
extension View {
    ...
    func neumorphicEffect(topBlur: CGFloat = 3, bottomBlur: CGFloat = 5, cornerRadius: CGFloat = 10,
                          topOffset: CGFloat = 3, bottomOffset: CGFloat = -2) -> some View {
        self.modifier(
            NeumorphicRectangle(topBlur: topBlur, bottomBlur: bottomBlur, cornerRadius: cornerRadius, topOffset: topOffset, bottomOffset: bottomOffset)
        )
    }
}
...
extension Color {
    ...
    // MARK: - オリジナル
    static let selectedLinear: LinearGradient = LinearGradient(gradient: Gradient(colors: [Color("Color1"), Color("Color2")]), startPoint: .topLeading, endPoint: .bottomTrailing)
    
    static let defaultOptionLinear: LinearGradient = LinearGradient(gradient: Gradient(colors: [Color.unselectedBackground, Color.unselectedBackground]), startPoint: .topLeading, endPoint: .bottomTrailing)
    
    static let defaultGraphLinear: LinearGradient = LinearGradient(gradient: Gradient(colors: [Color.graphUnselected, Color.graphUnselected]), startPoint: .topLeading, endPoint: .bottomTrailing)
    
    static let clearLinear: LinearGradient = LinearGradient(gradient: Gradient(colors: [Color.clear, Color.clear]), startPoint: .topLeading, endPoint: .bottomTrailing)
    
    static let defaultToggleLinear: LinearGradient = LinearGradient(gradient: Gradient(colors: [Color.graphUnselected, Color.unselectedBackground]), startPoint: .topLeading, endPoint: .bottomTrailing)
}
